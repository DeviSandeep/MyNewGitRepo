...
//Official website - https://extentreports.com/
//https://extentreports.com/docs/versions/4/java/index.html
public class ExtentReportUtility implements ITestListener {
	ExtentSparkReporter sparkReporter;//library class
	ExtentReports reports;//library class
	ExtentTest test;//library class
